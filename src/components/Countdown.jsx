...
function CountDown() {
    ...
    const calculateTimeLeft = () => {
        const difference = + new Date('2024-07-19T17:00:00') - + new Date();
        let timeLeft = {};
    ...
    return (
        <motion.div whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: 100 }} exit={{ opacity: 0 }} transition={{ duration: 1 }} className="grid grid-cols-5 sm:text-lg font-['wg'] bg-[rgba(0,0,0,0.3)] p-3 rounded-lg absolute bottom-40 text-white z-10">
